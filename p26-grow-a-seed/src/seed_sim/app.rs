...
use crate::seed_sim::system_updates::{enforce_maximum_entity_count, organ_lifespan_death, organ_production};
...
impl Plugin for PlantSimPlugin {
    fn build(&self, app: &mut App) {
        app
            ...
            .add_systems(Update, enforce_maximum_entity_count)
            .add_systems(Update, organ_lifespan_death)
